...
<title>Insert title here</title>
	<style>
		...
		section .btn {text-align: center; margin: 80px 0;} /* 중앙 정렬 및 상단 여백 */
		section .btn a {
...
<body>
	<section>
		...
		<div class="second">
			<div><h2>객실사진</h2></div>
	        <div><img src="../resources/room/${imgs[0]}"></div>
        ...
        <div class="btn">
            <a href="update?id=${rdto.id}">수정</a>
            <a href="delete?id=${rdto.id}">삭제</a>
        </div>
    </section>
</body>
</html>
